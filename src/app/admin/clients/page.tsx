        ...
        {showForm && (
          <div className="bg-[#141414] border border-white/[0.08] rounded-xl p-6 mb-8">
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-xs text-[rgba(245,242,239,0.5)] mb-1">Logo URL</label>
              ...
              <tbody>
                {list.map((item) => (
                  <tr key={item.id} className="border-t border-white/[0.08] hover:bg-white/[0.02]">
                    ...
                    <td className="px-4 py-3 truncate max-w-[200px]">{item.logo_url}</td>
                ...
                {list.length === 0 && (
                  <tr>
                    <td colSpan={4} className="px-4 py-8 text-center text-[rgba(245,242,239,0.5)]">Nessun cliente trovato</td>
                  </tr>
                )}
              </tbody>
            </table>
